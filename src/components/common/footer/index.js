      ...
      <div className='section6'>
        ...
        <section className="footer">
            <div className="section7">
                ...
                <hr/>
                <p className="third">&copy;By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy Policy and Content Policies. All trademarks are properties of their respective owners. 2008-2022 © Zomato™ Ltd. All rights reserved.</p>
